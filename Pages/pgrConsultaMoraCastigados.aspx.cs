...
{
    public partial class pgrConsultaMoraCastigados : System.Web.UI.Page
    {
        private ConexBD con;
        crConsultaMoraCastigados crp;
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sdadapter = con.rpConsultaMoraCastigados((String)Session["param1"]);

            dsConsultaMoraClientes ds = new dsConsultaMoraClientes();

            sdadapter.Fill(ds.tblConsultaMoraClientes);

            crp = new crConsultaMoraCastigados();
