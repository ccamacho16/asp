...
{
    public partial class pgpDesembolsoRangoFecha : System.Web.UI.Page
    {
        ...
        {   
            try{
                ...
                Page.Controls.Add(new LiteralControl("<script language='javascript'> window.open('" + "pgrDesembolsoRangoFecha.aspx" + "','_blank'); </script>"));          
             }
            catch (Exception ex)
            {
