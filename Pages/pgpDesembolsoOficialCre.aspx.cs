...
{
    public partial class pgpDesembolsoOficialCre : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Page.Controls.Add(new LiteralControl("<script language='javascript'> window.open('" + "pgrDesembolsoOficialCre.aspx" + "','_blank'); </script>"));
            }
            catch (Exception ex)
            {
