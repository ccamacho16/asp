...
{
    public partial class pgrComprobantePrestamo : System.Web.UI.Page
    {
        private ConexBD con;       
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sdadapter = con.rpComprobantePrestamo(idcab);

            dsComprobantePrestamo ds = new dsComprobantePrestamo();

            sdadapter.Fill(ds.tblComprobantePrestamo);

            crComprobantePrestamo crp = new crComprobantePrestamo();
            ...
            crp.SetParameterValue("ultimafecha", con.rpConsultaFechaMaxima(idcab));
            crp.SetParameterValue("fechades", (String)Session["param2"]);
