...
{
    public partial class pgrDesembolsoPendientes : System.Web.UI.Page
    {
        private ConexBD con;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter sdadapter = con.rpDesembolsoRangoFecha(fecha1, fecha2, "NODESEMBOLSADOS");
                ...
                crp.SetParameterValue("titulo", "REPORTE DE DESEMBOLSOS PENDIENTES");
