...
{
    public partial class pgrPagosRangoFecha : System.Web.UI.Page
    {
        private ConexBD con;
        crPagosRangoFecha crp;
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlDataAdapter sdadapter = con.rpPagosRangoFecha(fecha1, fecha2);

                dsPagosRangoFecha ds = new dsPagosRangoFecha();

                sdadapter.Fill(ds.tblPagosRangoFecha);

                crp = new crPagosRangoFecha();
