...
{
    public partial class pgpOtrosIngresosEgresos : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    DropDownList1.Items.Add("EGRESOS");
                    DropDownList1.Items.Add("INGRESOS");
                }
            }
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Session["param3"] = DropDownList1.SelectedValue;

                Page.Controls.Add(new LiteralControl("<script language='javascript'> window.open('" + "pgrOtrosIngresosEgresos.aspx" + "','_blank'); </script>"));
            }
            catch (Exception ex)
            {
