...
namespace SGCC.Pages
{
    ...
    public partial class pgRegistrarIngresos : System.Web.UI.Page
    {
        private ConexBD con;
        ...
        public void cargarIngresos()
        {
            ...
            dgastos = con.ConsultaValor_EntidadTipo("INGRESOS", "AGENCIA");
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            if (this.validarDatos())
            {
                msj = con.InsertarIngresos(Convert.ToDateTime(TextBox1.Text), "INGRESO: " + DropDownList1.SelectedValue, TextBox2.Text, TextBox3.Text.Replace('.', ','), "0.0");

                if (msj.Length == 0)
                {
                    //Label1.Text = "El Ingreso cargado se guardo con Exito";
                    this.Button3.Enabled = false;
                    if (CheckBox1.Checked)
                        this.GenerarReporte(Convert.ToDateTime(TextBox1.Text).ToString("dd/MM/yyyy"), DropDownList1.SelectedValue, TextBox2.Text, TextBox3.Text + " Bs.", "COMPROBANTE DE INGRESO");
                    else {
                        this.Message("El Ingreso se guardo con Exito.");
                    }
