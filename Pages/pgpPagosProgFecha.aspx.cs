...
{
    public partial class pgpPagosProgFecha : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Page.Controls.Add(new LiteralControl("<script language='javascript'> window.open('" + "pgrPagosProgFecha.aspx" + "','_blank'); </script>"));          
