<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/mtPlantilla.Master" AutoEventWireup="true" CodeBehind="pgClientes.aspx.cs" Inherits="SGCC.Pages.pgClientes" %>
...
<p align="right" style="text-align: right; font-size: x-large; font-family: Aharoni"> CLIENTES</p>
<table style="width:100%;">
          ...
          <tr>
              ...
              <td >
                  ...
                  <asp:DropDownList ID="DropDownList3" runat="server" Height="20px" Width="251px" 
                      Enabled="False">
                  </asp:DropDownList>
       ...
       <tr>
              ...
              <td align = "left">
                  ...
                  <asp:Button ID="Button7" runat="server" Text="▤ Print" Height="32px" 
                      Width="60px" onclick="Button7_Click" Visible="False"/>
