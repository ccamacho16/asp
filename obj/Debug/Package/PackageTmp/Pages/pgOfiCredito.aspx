<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/mtPlantilla.Master" AutoEventWireup="true" CodeBehind="pgOfiCredito.aspx.cs" Inherits="SGCC.Pages.pgOfiCredito" %>
...
<p align="right" style="text-align: right; font-size: x-large; font-family: Aharoni"> OFICIAL DE CREDITO</p>
<table style="width:100%;">
          ...
          <tr>
              ...
              <td>
                   ...
                   <asp:DropDownList ID="DropDownList1" runat="server" Height="21px" Width="123px" Enabled="False" 
                       >
