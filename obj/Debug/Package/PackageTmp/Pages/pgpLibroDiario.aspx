<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/mtPlantilla.Master" AutoEventWireup="true" CodeBehind="pgpLibroDiario.aspx.cs" Inherits="SGCC.Pages.pgpLibroDiario" %>
...
<table style="width:100%;">
    ...
    <td >
        <asp:TextBox ID="TextBox2" runat="server" 
            style="text-align: center; height: 22px;"  TextMode="Date"></asp:TextBox>
        </td><td></td>
    </tr>
