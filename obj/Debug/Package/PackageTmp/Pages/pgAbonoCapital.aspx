<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/mtPlantilla.Master" AutoEventWireup="true" CodeBehind="pgAbonoCapital.aspx.cs" Inherits="SGCC.Pages.pgAbonoCapital" %>
...
<p align="right" style="text-align: right; font-size: x-large; font-family: Aharoni"> ABONO A CAPITAL</p>
       ...
       <tr>
              ...
              <td align = "left" class="style4">
                  ...
                  <asp:Button ID="Button6" runat="server" Text="Guardar" Height="32px" 
                      Width="110px"  Visible="False" OnClientClick = "Confirmacion()" 
